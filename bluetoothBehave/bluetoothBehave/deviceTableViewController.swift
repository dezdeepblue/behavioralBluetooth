...
class deviceTableViewController: UITableViewController, LocalBehavioralSerialDeviceDelegate {
    ...
    func localDeviceStateChange() {
        print("Hardware" + String(myLocal.deviceState.hardwareState))
        print("Connection" + String(myLocal.deviceState.connectionState))
        print("Search" + String(myLocal.deviceState.searchState))
    }
